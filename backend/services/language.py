...
PROMPTS = {
    "en": {
        "ask_confirm": "Hello, this is Automaton AI. Do you confirm your order? Please say Yes or No.",
    ...
    "hi": {
        "ask_confirm": "नमस्ते, यह Automaton AI है। क्या आप अपना ऑर्डर कन्फर्म करते हैं? कृपया हाँ या नहीं कहें।",
    ...
    "kn": {
        "ask_confirm": "ನಮಸ್ಕಾರ, ಇದು Automaton AI. ನಿಮ್ಮ ಆದೇಶವನ್ನು ದೃಢೀಕರಿಸುತ್ತೀರಾ? ದಯವಿಟ್ಟು ಹೌದು ಅಥವಾ ಇಲ್ಲ ಎಂದು ಹೇಳಿ।",
    ...
    "mr": {
        "ask_confirm": "नमस्कार, हे Automaton AI आहे. कृपया तुमची ऑर्डर कन्फर्म करता का? होय किंवा नाही म्हणा.",
